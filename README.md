...
**Funcionalidades**  
Adicionar livro;  
Uploud de Capa, usando conversão da Base64;  
Avaliar Livros com sistema de estrelas;  
Adicionar notas de leitura;  
Editar livro;  
Deletar livro;  
Persistencia de dados, através do LocalStorage;  
Layout responsivo.
...
**Execute o projeto através do link:**  
https://sonnaly.github.io/my-library/
